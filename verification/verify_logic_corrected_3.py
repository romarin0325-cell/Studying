...
def test_logic():
    with sync_playwright() as p:
        ...
        # Verify Translations
        # Fix: Pass string correctly. The error implies JS side executed getBuffNameKR(defProtocolPhy) without quotes.
        # Python string interpolation issue?
        # Use simple string in JS.
