...
def test_logic():
    with sync_playwright() as p:
        ...
        # Verify Protocol Translations in getBuffNameKR via console (Need quotes for string!)
        ...
        page.evaluate('''() => {
            ...
            // Start Enemy Turn (which will set protocol, apply stats, then start Player Turn which renders)
            startEnemyTurn();
        }''')
