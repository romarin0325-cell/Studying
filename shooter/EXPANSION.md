...
- Implement all nine normal and six rare artifacts; stacking additive within attack or bomb bonuses. Shield consumes a bomb on hit; mask consumes one life for an empty-stock bomb only while life > 1. World Tree fairy deals real auxiliary damage. Base max life 4 (previous healing cap 6 minus 2), starting life normal 3/easy 4; hard max/start 3. Every heal respects modified max.
