...
const assets = {};
for (const name of ['heroes', 'bosses', 'enemies', 'worlds', 'companions', 'secrets', 'sentinels','relics','tides','bloom-fx','tide-worlds','tide-relics','shield-relics']) {
...
const modules = [
  ...
  ['meta.js', ['ARTIFACTS','DIFFICULTIES','BASE_HEROES','ACHIEVEMENTS','normalizeDifficulty','randomHero','consumeRandom','randomRemaining','dayKey','weekKey','dailyHeroes','createProfile','recordDungeonClear','achievementProgress','heroAvailable','unlockHero','claimDungeon','drawArtifact','loadoutStats']],
