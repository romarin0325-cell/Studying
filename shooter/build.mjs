...
const modules = [
  ...
  ['meta.js', ['ARTIFACTS','DIFFICULTIES','normalizeDifficulty','randomHero','consumeRandom','randomRemaining','dayKey','weekKey','dailyHeroes','createProfile','heroAvailable','unlockHero','claimDungeon','drawArtifact','loadoutStats']],
