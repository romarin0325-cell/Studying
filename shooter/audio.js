...
export class AudioDirector {
  ...
  schedule() {
    ...
    while (this.next < c.currentTime + .22) {
      const scales = [[0, 3, 7, 10, 12, 7, 3, 10], [0, 4, 7, 11, 12, 7, 4, 11], [0, 3, 6, 10, 12, 10, 6, 3], [0, 4, 7, 9, 12, 9, 7, 4], [0, 2, 5, 7, 12, 7, 5, 2], [0, 2, 7, 10, 12, 7, 2, 10], [0, 4, 7, 11, 14, 11, 7, 4]];
      const roots = [57, 53, 56, 60, 50, 52, 62], chord = [0, -5, -2, -7][Math.floor(this.step / 32) % 4], scale = scales[this.stage];
