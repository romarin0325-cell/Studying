export const HEROES = [
  ...
  { id: 'luna', name: '루나', title: '달그림자의 암살자', en: 'LUNA', color: '#c7a4ff', shadow: '#6340aa', sigil: '☾', quote: '눈을 감아. 그림자는 내가 벨 테니까.', description: '달빛을 삼킨 칼날, 소리 없이 펼쳐지는 어둠.', bomb: '이클립스', bombInfo: '탄을 지우고 3초간 무적. 그림자 분신이 적을 연속으로 베어요.', weapons: [
  ...
  { id: 'zeke', radius: 6, speed: 1100, name: '지크', title: '새벽을 여는 화염검사', en: 'ZEKE', color: '#ffb27e', shadow: '#a04430', sigil: '✦', quote: '길이 없다면, 내가 먼저 열겠어.', description: '꺾이지 않는 검과 세 갈래로 타오르는 불꽃.', bomb: '샤이닝플레임', bombInfo: '불사조가 전장을 휩쓸어요. 4초간 화력이 75% 증가해요.', weapons: [
...
STAGES[5].hp=17000;STAGES[5].id=5;DUNGEONS[5].id=5;
