export const HEROES = [
  { id: 'rumi', name: '루미', title: '별을 엮는 대현자', en: 'RUMI', color: '#84ebf4', shadow: '#247d9f', sigil: '✧', quote: '가장 어두운 밤에도, 별은 네 곁에.', description: '별을 엮는 마법으로 유도탄과 집중 레이저를 펼치는 수호자.', bomb: '꿈의형태', bombInfo: '별빛이 모든 탄을 지우고, 4초간 유성우가 쏟아져요.', weapons: [
  ...
  { id: 'luna', name: '루나', title: '달그림자의 암살자', en: 'LUNA', color: '#c7a4ff', shadow: '#6340aa', sigil: '☾', quote: '눈을 감아. 그림자는 내가 벨 테니까.', description: '달빛을 삼킨 칼날로 관통 공격과 근접전을 펼치는 수호자.', bomb: '이클립스', bombInfo: '탄을 지우고 2초간 무적. 그림자 분신이 적을 연속으로 베어요.', weapons: [
  ...
  { id: 'jasmine', name: '자스민', title: '꽃과 원소의 성녀', en: 'JASMINE', color: '#f5dba2', shadow: '#9f793e', sigil: '❀', quote: '상처 난 하늘에도, 다시 꽃은 피어나요.', description: '꽃과 원소의 기도로 연쇄 번개와 수호 꽃잎을 펼치는 수호자.', bomb: '더홀리', bombInfo: '탄을 지우고 생명 1개를 회복해요. 3초간 성역이 적을 공격해요.', weapons: [
...
HEROES.push(
  { id: 'snow', radius: 4, name: '눈토끼', title: '겨울을 깨우는 설원 마법사', en: 'SNOW RABBIT', color: '#a5eaff', shadow: '#467dad', sigil: '❄', quote: '차가운 바람도, 우리 편으로 만들면 돼.', description: '얼음 결정으로 적을 늦추고 튕기는 눈꽃을 펼치는 수호자.', bomb: '프로즌 월드', bombInfo: '3초간 눈보라로 공격해요. 무적이 끝난 뒤에도 5초간 적과 적탄의 감속이 남아요.', weapons: [
  ...
  { id: 'cinderella', hidden: true, lifeBonus: 1, name: '신데렐라', title: '자정을 거스르는 유리 마법사', en: 'CINDERELLA', color: '#ffc4e3', shadow: '#a35196', sigil: '♢', quote: '열두 시가 지나도, 우리의 마법은 계속돼.', description: '자정을 거스르는 유리 마법으로 관통창과 폭발 표식을 펼치는 수호자.', bomb: '미드나잇 · 미라클', bombInfo: '유리시계가 탄을 지우고, 3초간 유리 결정이 적에게 연속으로 폭발해요.', weapons: [
...
HEROES.push(
  ...
  { id: 'sisters', bombBonus: 1, name: '루나&자스민', hidden: true, lifeBonus: 1, radius: 6, title: '이야기 속에서만 만난 내일', en: 'AN UNWRITTEN TOMORROW', color: '#e3c4fa', shadow: '#866599', sigil: '∞', quote: '이 이야기에서만큼은, 끝까지 손을 놓지 말자.', description: '서로의 진심을 이해한 미래를 그리며 두 사람의 빛을 함께 펼치는 수호자.', bomb: '끝나지 않는 이야기', bombInfo: '함께 바란 내일이 펼쳐져 3초간 탄을 지우고 전장을 감싸요.', weapons: [
  ...
  { id: 'time', name: '시간의마술사', hidden: true, lifeBonus: 1, title: '열두 시에 남겨진 소망', en: 'THE TIME MAGICIAN', color: '#efa5ed', shadow: '#875397', sigil: '◷', quote: '이번에는… 다른 결말일 수 있을까.', description: '되감은 시간의 바늘과 멈춘 궤도로 전장을 다시 쓰는 수호자.', bomb: '다크신데렐라', bombInfo: '약한 전체 공격 후 10초간 강력한 유리탄을 쏴요. 무적은 처음 2초예요.', weapons: [
...
export const STAGES = [
  { id: 0, name: '푸른 시간의 유적', en: 'THE AZURE RUINS', boss: '인조마신', subtitle: '별을 모방한 마음', color: '#7de4f5', dark: '#071d34', pattern: ['프리즘 세례', '청금석의 궤도', '불완전한 태양'], intro: '나는… 누구의 소원을 위해 태어났지?', outro: '따뜻해… 이게 진짜 별빛이구나.', duration: 42, hp: 5500 },
  { id: 1, name: '영원한 장미 정원', en: 'THE ETERNAL GARDEN', boss: '사랑의 여신 아이리스', subtitle: '놓아주지 못한 사랑', color: '#ffb4da', dark: '#321831', pattern: ['장미의 약속', '포옹의 나선', '영원이라는 새장'], intro: '여기 머물러요. 영원히 사랑받을 수 있도록.', outro: '사랑은… 붙잡는 것만은 아니었군요.', duration: 46, hp: 7200 },
  { id: 2, name: '빛을 잃은 성당', en: 'THE HOLLOW CATHEDRAL', boss: '저주의 여신 아일스', subtitle: '일곱 빛깔의 저주', color: '#cea1ff', dark: '#201330', pattern: ['깨진 무지개', '금단의 회랑', '일곱 번째 저주'], intro: '예쁜 빛일수록, 부서질 때 더 반짝이거든.', outro: '이런 결말도… 나쁘지는 않네.', duration: 50, hp: 9400 },
  { id: 3, name: '검은 태양의 왕좌', en: 'THRONE OF THE ECLIPSE', boss: '마신 벨제뷔트', subtitle: '마지막 밤의 군주', color: '#ed9bff', dark: '#1b102c', pattern: ['심연의 칙령', '멸망의 왕관', '검은 태양'], intro: '별은 꺼진다. 너희의 작은 소원도.', outro: '이 작은 빛들이… 밤을 끝내는가.', duration: 54, hp: 17000 }
];
...
STAGES.splice(3,0,
  { id:3,name:'요정의 숲',en:'FOREST OF FAIRIES',boss:'꽃의 여신 플로라',subtitle:'다시 피어나는 소원',color:'#ffb4de',dark:'#112a29',pattern:['꽃잎의 윤무','봄의 미로','만개'],intro:'작은 꽃도 자신의 계절을 기다려요.',outro:'당신의 소원도… 피어나기를.',duration:54,hp:11900 },
  { id:4,name:'해저신전',en:'THE SUNKEN TEMPLE',boss:'해신 포세이돈',subtitle:'깊은 바다의 심판',color:'#77e6ff',dark:'#082636',pattern:['해류의 창','해신의 십자','대해일'],intro:'심연을 건넌 자여, 파도를 견뎌라.',outro:'너희의 의지… 바다에도 새겨 두마.',duration:58,hp:14500 }
);
DUNGEONS.splice(3,0,
