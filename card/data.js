...
const BONUS_CARD_EXPANSION = [
    ...
    },
    {
        ...
        skills: [
            { name: '회피태세', type: 'sup', tier: 1, cost: 10, desc: '회피율 50% 증가', effects: [{ type: 'buff', id: 'evasion', duration: 1 }] },
            { name: '실프스탭', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '3턴간 지속되는 필드버프 질풍 발동', effects: [{ type: 'field_buff', id: 'gale', durationTurns: 3 }] },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '드림파이어', type: 'mag', tier: 3, cost: 30, val: 2.0, desc: '마법 공격 후 회피 태세 진입', effects: [{ type: 'buff', id: 'evasion', duration: 1 }] }
        ]
    }
];
