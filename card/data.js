const CARDS = [
    // --- 전설 (Legend) ---
    {
        ...
        skills: [
            ...
            { name: '피날레', type: 'mag', tier: 3, cost: 30, val: 2.5, desc: '필드버프를 제거하고 제거한 수 x2.5 만큼 위력 증가' },
    ...
    },
    {
        ...
        trait: { type: 'cond_no_field_buff_eva', val: 30, desc: '필드버프가 없을 시 회피율 30%증가' },
        skills: [
            { name: '회피태세', type: 'sup', tier: 1, cost: 10, desc: '회피율 50% 증가' },
            { name: '이클립스', type: 'phy', tier: 3, cost: 30, val: 2.5, desc: '암흑 상태의 적에게 대미지 2배' },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '얼티밋브레스', type: 'mag', tier: 3, cost: 30, val: 1.5, desc: '작열스택 부여, 작열스택 하나당 0.5배율 추가' },
    ...
    },
    {
        ...
        skills: [
            { name: '배리어', type: 'sup', tier: 2, cost: 20, desc: '물리공격 무효' },
            { name: '더홀리', type: 'mag', tier: 2, cost: 20, val: 2.0, desc: '디바인 스택이 있을 시, 필드버프 성역 발동' },
    ...
    },
    {
        ...
        skills: [
            { name: '가드', type: 'sup', tier: 1, cost: 10, desc: '대미지 반감' },
            { name: '이그니스스매시', type: 'mag', tier: 2, cost: 20, val: 2.0, desc: '작열스택을 전부 소모하고 소모당 1.5배율 추가' },
            { name: '라그나로크', type: 'phy', tier: 3, cost: 30, val: 2.5, desc: '생명력 50% 아래에서 대미지 2배' }
        ]
    },
    {
        ...
        skills: [
            ...
            { name: '종언의예고', type: 'phy', tier: 3, cost: 30, val: 5.0, desc: '사용 후 3턴 뒤에 공격' },
    ...
    },
    {
        ...
        skills: [
            { name: '회피태세', type: 'sup', tier: 1, cost: 10, desc: '회피율 50% 증가' },
            { name: '데스핸드', type: 'phy', tier: 2, cost: 20, val: 1.5, desc: '적에게 걸린 디버프 1종당 0.5배율 추가' },
    ...
    },
    {
        ...
        skills: [
            { name: '배리어', type: 'sup', tier: 2, cost: 20, desc: '물리공격 무효' },
            { name: '레인오브썬더', type: 'mag', tier: 3, cost: 30, val: 2.0, desc: '디바인스택 전부 소모하고 1개당 2배율 추가' },
            { name: '썬더스톰', type: 'mag', tier: 2, cost: 20, val: 1.5, desc: '적 디버프 1종당 0.5배율 추가' }
        ]
    },
    {
        id: 'flame_sage', name: '화염의현자', grade: 'epic', element: 'fire', role: 'buffer',
        stats: { hp: 380, atk: 75, matk: 105, def: 65, mdef: 80 },
        trait: { type: 'syn_fire_3_crit', val: 20, desc: '덱에 불 3장일시 치명타 확률 20%증가' },
        skills: [
            { name: '매직가드', type: 'sup', tier: 2, cost: 20, desc: '마법공격 무효' },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '아이스에이지', type: 'mag', tier: 3, cost: 30, val: 3.0, desc: '1~5배율 사이로 랜덤공격' }
        ]
    },
    {
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '네더커스', type: 'sup', tier: 2, cost: 20, desc: '저주 침묵 약화 부식 중 랜덤 2종 부여' }
        ]
    },
    ...
    // --- 레어 (Rare) ---
    {
        ...
        skills: [
            { name: '가드', type: 'sup', tier: 1, cost: 10, desc: '대미지 반감' },
            { name: '베이비브레스', type: 'mag', tier: 1, cost: 10, val: 1.5, desc: '작열부여' },
            { name: '드래곤크로', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '2배 물리' }
        ]
    },
    {
    ...
    },
    {
        ...
        skills: [
            { name: '회피태세', type: 'sup', tier: 1, cost: 10, desc: '회피율 50% 증가' },
            { name: '프로스트팽', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '부식부여' },
            { name: '버서크바이트', type: 'mag', tier: 3, cost: 30, val: 2.0, desc: '달의축복 상태에서 대미지 2배' }
        ]
    },
    {
        ...
        skills: [
            { name: '배리어', type: 'sup', tier: 2, cost: 20, desc: '물리공격 무효' },
            { name: '깡총깡총', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '어둠 상태시 추가 0.5배' },
            { name: '문라이트', type: 'mag', tier: 2, cost: 20, val: 1.5, desc: '달의축복 상태에서 대미지 2배' }
        ]
    },
    {
    ...
    },
    {
        ...
        skills: [
            { name: '가드', type: 'sup', tier: 1, cost: 10, desc: '대미지 반감' },
            { name: '차지어택', type: 'phy', tier: 2, cost: 20, val: 2.5, desc: '다음턴 휴식' },
    ...
    },
    {
        ...
        skills: [
            { name: '매직가드', type: 'sup', tier: 2, cost: 20, desc: '마법공격 무효' },
            { name: '샌드스톰', type: 'mag', tier: 2, cost: 20, val: 1.5, desc: '부식 저주 중 하나 부여' },
    ...
    },
    {
        ...
        skills: [
            { name: '회피태세', type: 'sup', tier: 1, cost: 10, desc: '회피율 50% 증가' },
            { name: '베어러쉬', type: 'phy', tier: 1, cost: 10, val: 1.0, desc: '상대가 약화시 2배' },
            { name: '강타', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '2배 물리' }
        ]
    },
    {
        ...
        skills: [
            { name: '회피태세', type: 'sup', tier: 1, cost: 10, desc: '회피율 50% 증가' },
            { name: '블러드드레인', type: 'mag', tier: 1, cost: 10, val: 1.0, desc: '상대가 저주시 2배' },
            { name: '다크니스', type: 'mag', tier: 2, cost: 20, val: 2.0, desc: '2배 마법' }
        ]
    },
    {
    ...
    },
    {
        ...
        trait: { type: 'syn_light_fire_atk', val: 20, desc: '덱에 빛 불이 있을시 공격 20%증가' },
        skills: [
            { name: '가드', type: 'sup', tier: 1, cost: 10, desc: '대미지 반감' },
    ...
    },
    {
        ...
        skills: [
            { name: '회피태세', type: 'sup', tier: 1, cost: 10, desc: '회피율 50% 증가' },
            { name: '산성액', type: 'mag', tier: 1, cost: 10, val: 1.0, desc: '부식부여' },
            { name: '강타', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '2배 물리' }
        ]
    },
    {
...
// Stats reduced by 10 for ATK/MATK
const ENEMIES = [
    {
        ...
        skills: [
            ...
            { name: '파괴의형태', type: 'mag', rate: 0.0, val: 4.0, desc: '10턴째 4배 마법' }
        ]
    },
    {
