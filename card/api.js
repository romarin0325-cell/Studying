...
암기 비법 (Memorization & Imagery): 단어를 쉽게 외울 수 있는 꿀팁을 제공하십시오.
        ...
        - 과도하게 어원을 연상법으로 제시하는 대신, **페어 단어(Distinguish from)와의 차이를 해당 단어의 의미와 연관지어 연상하기 쉬운 방법**을 우선적으로 제시하십시오.
        - 적절한 연상법이 없을 경우에만 **어원(Prefix/Root)**을 이용한 설명으로 차이를 비교하십시오.
        - **'루미와 형아가 겪는 특정한 상황'** 한 장면을 묘사하여 그 상황과 단어를 연결하는 것도 좋습니다. (오해유발 이벤트에 경우는 제시된 상황에 맞게 연결)
