...
const CARDS = [
    ...
    // --- Epic ---
    {
        ...
        skills: [
            { name: '배리어', type: 'sup', tier: 1, cost: 10, desc: '물리공격 무효', effects: [{ type: 'buff', id: 'barrier', duration: 1 }] },
            { name: '러스트브리즈', type: 'mag', tier: 2, cost: 20, val: 2.0, desc: '적에게 [약화, 부식] 중 무작위 1종 부여', effects: [{ type: 'random_debuff', count: 1, pool: ['weak', 'corrosion'] }] },
    ...
    },
    {
        ...
        skills: [
            { name: '배리어', type: 'sup', tier: 1, cost: 10, desc: '물리공격 무효', effects: [{ type: 'buff', id: 'barrier', duration: 1 }] },
            { name: '푸딩러쉬', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '적에게 [약화, 침묵] 중 무작위 1종 부여', effects: [{ type: 'random_debuff', count: 1, pool: ['weak', 'silence'] }] },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '네더커스', type: 'sup', tier: 2, cost: 20, desc: '적에게 [저주, 침묵, 약화, 부식] 중 무작위 2종 부여', effects: [{ type: 'random_debuff', count: 2, pool: ['curse', 'silence', 'weak', 'corrosion'] }] }
        ]
    },
    {
        ...
        skills: [
            { name: '배리어', type: 'sup', tier: 1, cost: 10, desc: '물리공격 무효', effects: [{ type: 'buff', id: 'barrier', duration: 1 }] },
            { name: '스피릿왈츠', type: 'mag', tier: 2, cost: 20, val: 1.5, desc: '적이 디바인 3스택이면 대미지 2배 + 스턴, 아니면 디바인 부여', effects: [{ type: 'dmg_boost', condition: 'target_stack_at_least', debuff: 'divine', count: 3, mult: 2.0 }, { type: 'check_divine_3_stun_else_add' }] },
            { name: '이터널위스퍼', type: 'mag', tier: 3, cost: 30, val: 2.5, desc: '적에게 [저주, 암흑, 침묵, 약화, 부식] 중 무작위 1종 부여 (디바인 소모 시 무작위 2종)', effects: [{ type: 'random_debuff_consume_divine' }] }
        ]
    },
...
const BONUS_CARDS = [
    ...
    },
    {
        ...
        skills: [
            { name: '매직가드', type: 'sup', tier: 1, cost: 10, desc: '마법공격 무효', effects: [{ type: 'buff', id: 'magic_guard', duration: 1 }] },
            { name: '크리스탈킥', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '적에게 작열 1스택을 부여하고, [약화, 부식] 중 무작위 1종 추가 부여', effects: [{ type: 'debuff', id: 'burn', stack: 1 }, { type: 'random_debuff', count: 1, pool: ['weak', 'corrosion'] }] },
            { name: '미드나잇스펠', type: 'mag', tier: 3, cost: 30, val: 2.5, desc: '적에게 디바인 1스택을 부여하고, [침묵, 저주] 중 무작위 1종 추가 부여', effects: [{ type: 'debuff', id: 'divine', stack: 1 }, { type: 'random_debuff', count: 1, pool: ['silence', 'curse'] }] }
        ]
    },
    {
        ...
        skills: [
            { name: '매직가드', type: 'sup', tier: 1, cost: 10, desc: '마법공격 무효', effects: [{ type: 'buff', id: 'magic_guard', duration: 1 }] },
            { name: '봉인부', type: 'mag', tier: 3, cost: 30, val: 2.5, desc: '적에게 [부식, 약화, 침묵, 저주, 암흑] 중 무작위 2종 부여', effects: [{ type: 'random_debuff', count: 2, pool: ['corrosion', 'weak', 'silence', 'curse', 'darkness'] }] },
    ...
    },
    {
        ...
        trait: { type: 'on_hit_random_debuff', pool: ['corrosion', 'weak', 'silence', 'curse', 'stun'], desc: '해파리독: 피격 시 적에게 [부식, 약화, 침묵, 저주, 기절] 중 무작위 1종 부여' },
        skills: [
            { name: '가드', type: 'sup', tier: 1, cost: 10, desc: '대미지 반감', effects: [{ type: 'buff', id: 'guard', duration: 1 }] },
            { name: '오로라텐타클', type: 'mag', tier: 2, cost: 20, val: 2.0, desc: '적에게 [약화, 부식] 중 무작위 1종 부여', effects: [{ type: 'random_debuff', count: 1, pool: ['weak', 'corrosion'] }] },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '콜드웨이크', type: 'mag', tier: 2, cost: 20, val: 1.5, desc: '적에게 [저주, 침묵] 중 무작위 1종 부여', effects: [{ type: 'random_debuff', count: 1, pool: ['curse', 'silence'] }] }
        ]
    },
    {
        ...
        skills: [
            { name: '가드', type: 'sup', tier: 1, cost: 10, desc: '대미지 반감', effects: [{ type: 'buff', id: 'guard', duration: 1 }] },
            { name: '황금폭풍', type: 'mag', tier: 2, cost: 20, val: 1.0, desc: '작열 1스택 소모 시 적에게 [약화, 부식, 저주, 침묵] 중 무작위 2종 부여', effects: [{ type: 'consume_debuff_then_random_debuff', debuff: 'burn', count: 1, randomCount: 2, pool: ['weak', 'corrosion', 'curse', 'silence'], customLog: '작열 1스택 소모!' }] },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '와일드카드', type: 'sup', tier: 10, cost: 100, desc: '적의 디버프를 모두 제거하고 적에게 [저주, 암흑, 침묵, 약화, 부식, 작열, 디바인, 유혹] 중 무작위 2종 부여', effects: [{ type: 'wild_card_debuff' }] }
        ]
    }
];
...
const BONUS_CARD_EXPANSION = [
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '앵커체인', type: 'phy', tier: 2, cost: 20, val: 2.0, desc: '물리 2배율, 적에게 [침묵, 부식] 중 무작위 1종 부여', effects: [{ type: 'random_debuff', count: 1, pool: ['silence', 'corrosion'] }] },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '블레이즈크로', type: 'mag', tier: 3, cost: 30, val: 2.0, desc: '마법 2배율, 적에게 [약화, 침묵] 중 무작위 1종 부여', effects: [{ type: 'random_debuff', count: 1, pool: ['weak', 'silence'] }] }
        ]
    },
    {
    ...
    },
    {
        ...
        skills: [
            ...
            { name: '플래이그', type: 'mag', tier: 2, cost: 20, val: 1.0, desc: '5턴에 걸쳐 매 턴 1배 마법대미지와 적에게 [약화, 침묵, 부식, 저주, 암흑, 디바인, 작열, 유혹] 중 무작위 1종 부여', effects: [{ type: 'multi_delayed_attack', turns: [1, 2, 3, 4, 5], messages: ['첫번째 플래이그!', '두번째 플래이그!', '세번째 플래이그!', '네번째 플래이그!', '마지막 플래이그!'] }, { type: 'random_debuff', pool: ['weak', 'silence', 'corrosion', 'curse', 'darkness', 'divine', 'burn', 'temptation'], count: 1 }] },
