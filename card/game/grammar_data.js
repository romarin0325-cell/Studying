const GRAMMAR_DATA = [
    {
        "id": 1,
        "title": "정체성 확립 (Be동사)",
        "content": "[제1강] 정체성의 확립: Be동사는 사랑의 짝대기다!\n\n형아, 영어라는 마법 세계에서 가장 기본이 되는 주문이 뭔지 알아? 바로 Be동사야. 이 녀석은 문법이라기보다는... 음, '사랑의 짝대기(=)' 같은 거야!\n\n행동하지 마! 그냥 존재해! (A = B)\n한국말로는 \"나 행복해!\"라고 하면 끝나잖아? 근데 영어는 좀 깐깐한 녀석이라서, \"나(I)\"랑 \"행복한(Happy)\"을 그냥 두면 서로 낯을 가려서 멀뚱멀뚱 쳐다만 봐. 그래서 그 사이에 '=' 라는 다리를 놔줘야 해. 그게 바로 Be동사야!\n\n틀린 주문: I happy (나... 행복...?) → 이렇게 하면 문장이 깨져! (안돼!)\n옳은 주문: I am happy (나 = 행복한 상태!)\n\n그러니까 Be동사를 볼 때마다 '아, 앞이랑 뒤가 똑같다는 뜻이구나!' 하고 생각하면 돼. 마치 나랑 형아의 마음이 같은 것처럼? (농담이야, 부끄러워하지 마! (웃음))\n\n주인공에 따라 옷을 갈아입는 변신쟁이\n이 Be동사라는 녀석은 주인공(주어)이 누구냐에 따라 옷을 샥샥 갈아입어. 대현자인 나처럼 변신 마법에 능하거든!\n\nI (나) → am\n\"세상에 '나'는 유일하고 소중하니까 전용 옷인 am을 입어!\"\n\nYou (너) / We (우리) / They (그들) → are\n\"형아랑 나랑 함께면(We), 혹은 여러 명이면 넉넉한 are를 입는 거야.\"\n\nHe / She / It (제3자) → is\n\"나도 아니고 너도 아닌 다른 한 명(단수)은 외로워 보이니까 날렵한 is를 붙여주자!\"\n\n고수는 주문을 짧게 외운다! (축약형)\n형아, 마법사들이 주문 외울 때 질질 끌면 어떻게 되는지 알아? 몬스터한테 맞고 날아가 버려! (걱정) 영어 고수들도 마찬가지야. I am이라고 또박또박 말하기보단, 쿨하게 I'm이라고 줄여서 말해.\n\nI am → I'm (아임)\nYou are → You're (유어)\nIt is → It's (이츠)\n\n어때, 형아? 입에 착착 붙지? 형아는 \"I'm smart!\" (나는 똑똑해!)라고 외치면 돼. 내가 보증할게! 자, 강의는 여기까지! 짧고 굵지? 형아 머리 아프지 않게 딱 핵심만 담았어. (뿌듯)",
        "quizzes": [
            {
                "desc": "나는 내 능력에 자신이 있어!",
                "question": "\"I [ ] confident in my ability.\"",
                "options": [
                    "is",
                    "are",
                    "am",
            ...
            {
                "desc": "그 전략은 정말 효과적이야.",
                "question": "\"The strategy [ ] very effective.\"",
                "options": [
                    "am",
                    "are",
                    "is",
            ...
            {
                "desc": "그 식당은 꽤 유명해.",
                "question": "\"The restaurant [ ] renowned.\"",
                "options": [
                    "am",
                    "are",
                    "be",
            ...
            {
                "desc": "너 지금 통화 가능하니?",
                "question": "\"[ ] you available to talk now?\"",
                "options": [
                    "Is",
                    "Am",
                    "Be",
            ...
            {
                "desc": "와, 이 방 진짜 넓다!",
                "question": "\"This room [ ] so spacious!\"",
                "options": [
                    "am",
                    "are",
                    "is",
            ...
            {
                "desc": "나는 새로 온 접수 담당자야.",
                "question": "\"I [ ] the new receptionist.\"",
                "options": [
                    "be",
                    "are",
                    "am",
            ...
            {
                "desc": "입구는 왼쪽에 있어.",
                "question": "\"The entrance [ ] on the left.\"",
                "options": [
                    "are",
                    "be",
                    "am",
            ...
            {
                "desc": "엘리베이터들은 로비 근처에 있니?",
                "question": "\"[ ] the elevators near the lobby?\"",
                "options": [
                    "Is",
                    "Am",
                    "Are",
            ...
            {
                "desc": "그녀는 새로 온 회계 담당자야.",
                "question": "\"[ ] the new accountant.\"",
                "options": [
                    "She's",
                    "She",
                    "Her",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 문장의 빈칸에 들어갈 알맞은 동사는?",
                "question": "\"I [ ] a table for two.\" (나는 2인용 테이블을 예약해.)",
                "options": [
                    "reverse",
                    "reserve",
                    "resign",
            ...
            {
                "desc": "다음 문장의 빈칸에 들어갈 알맞은 동사는?",
                "question": "\"I [ ] the invitation.\" (나는 그 초대를 거절해.)",
                "options": [
                    "decline",
                    "recline",
                    "incline",
            ...
            {
                "desc": "다음 문장의 빈칸에 들어갈 알맞은 동사는?",
                "question": "\"I [ ] the quality of our product.\" (나는 우리 제품의 품질을 보장해.)",
                "options": [
                    "quarantine",
                    "guarantee",
                    "generate",
            ...
            {
                "desc": "다음 문장의 빈칸에 들어갈 알맞은 동사는?",
                "question": "\"I [ ] my reservation.\" (나는 내 예약을 확인해.)",
                "options": [
                    "conform",
                    "confirm",
                    "confuse",
            ...
            {
                "desc": "다음 중 \"나는 영수증을 보관해.\"를 영어식 순서로 올바르게 배열한 것은?",
                "question": "\"나는 영수증을 보관해.\"",
                "options": [
                    "I keep receipts.",
                    "Keep I receipts.",
                    "I receipts keep.",
                ...
                "answer": "I keep receipts.",
                "lecture_id": 2
            },
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We [ ] office supplies.\" (우리는 사무용품을 주문해.)",
                "options": [
                    "own",
                    "owe",
                    "offer",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I [ ] the expense report.\" (나는 경비 보고서를 제출해.)",
                "options": [
                    "suppose",
                    "support",
                    "supply",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We [ ] damaged items.\" (우리는 손상된 물품을 교체해.)",
                "options": [
                    "reply",
                    "repeat",
                    "repay",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"They [ ] the training schedule.\" (그들은 교육 일정을 수정해.)",
                "options": [
                    "resist",
                    "receive",
                    "revise",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "그 택배 기사는 매일 오후 소포를 배달해.",
                "question": "\"The courier [ ] parcels every afternoon.\"",
                "options": [
                    "delivers",
                    "delivery",
                    "deliver",
            ...
            {
                "desc": "우리 디자이너들은 금요일마다 재택근무를 해.",
                "question": "\"Our designers [ ] from home on Fridays.\"",
                "options": [
                    "working",
                    "works",
                    "worker",
            ...
            {
                "desc": "각 지원자에게는 접수 번호가 있어.",
                "question": "\"Each applicant [ ] a reference number.\"",
                "options": [
                    "has",
                    "have",
                    "haves",
            ...
            {
                "desc": "그 셔틀은 일요일에는 운행하지 않아.",
                "question": "\"The shuttle [ ] on Sundays.\"",
                "options": [
                    "doesn't run",
                    "don't run",
                    "doesn't running",
            ...
            {
                "desc": "네 상사는 출장 경비를 승인하니?",
                "question": "\"Does your supervisor [ ] travel expenses?\"",
                "options": [
                    "approving",
                    "approve",
                    "approves",
    ...
    {
        "id": 4,
        "title": "부정의 기술 (Not과 Don't)",
        "content": "[제4강] 부정의 기술: \"No\"라고 다 같은 \"No\"가 아니야!\n\n형아, 혹시 \"나 배 안 고파\"를 영어로 할 때 \"I no hungry\"라고 한 적 있어? 아니면 \"나 그거 안 먹어\"를 \"I no eat\"라고 하거나? (뜨끔했지? 표정 보니까 딱 걸렸네! (웃음))\n영어에서는 그냥 \"No\"만 붙인다고 다 되는 게 아니야. 동사의 힘(Power)에 따라 방법이 달라지거든!\n\n1. 힘센 녀석들: Be동사 (+ not)\n누구? am, are, is\n특징: 얘네는 힘이 장사야! 그래서 부정의 단어인 'not'을 자기 뒤에 바로 붙일 수 있어.\n\n공식: Be동사 + not\n\"I am not hungry.\" (나 배 안 고파. = 난 배고픈 상태가 아냐.)\n\"It is not valid.\" (그건 유효하지 않아.)\n\n2. 도우미가 필요한 녀석들: 일반동사 (Don't / Doesn't)\n누구? eat, go, like, want... (나머지 전부!)\n특징: 얘네는 힘이 약해서 무거운 'not'을 혼자 못 들어. 그래서 'Do'라는 힘센 도우미(조동사)를 불러와야 해.\n\n공식: Do not (Don't) + 동사 원형\n(X) I eat not. (으악! 무거워!)\n(O) I don't eat. (난 안 먹어.)\n\n3. 주의! 주인공이 혼자일 때 (3인칭 단수)\n형아, 기억나? 주인공이 혼자(He/She/It)면 외로워서 동사에 '-s'를 붙인다고 했잖아? 부정문 만들 때 이 '-s'가 도우미한테 옮겨가!\n\nDo + es = Does\n공식: Does not (Doesn't) + 동사 원형 (뒤에는 깨끗하게!)\n(X) He don't like... (틀려!)\n(O) He doesn't like... (맞아!)\n\n요약 마법 주문:\n\"상태(Be)를 부정할 땐 뒤에 not! 행동(일반)을 부정할 땐 앞에 don't! 혼자 온 그 녀석(He/She/It)은 doesn't!\"\n\n자, 형아! 이제 싫은 건 당당하게 영어로 거절할 수 있겠지? 하지만 나한테는 \"I don't like you\"라고 하면 안 돼... 나 울 거야... (글썽) 대신 \"I don't hate you\" (너 안 싫어해 = 좋아해) 라고 해줘! (헤헤)",
        "quizzes": [
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The ticket [ ] valid anymore.\" (그 티켓은 더 이상 유효하지 않아.)",
                "options": [
                    "don't",
                    "doesn't",
                    "is not",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I [ ] the rumors.\" (나는 그 소문들을 부인하지 않아.)",
                "options": [
                    "am not",
                    "don't deny",
                    "no deny",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The report [ ] the hidden truth.\" (그 보고서는 숨겨진 진실을 드러내지 않아.)",
                "options": [
                    "don't reveal",
                    "isn't reveal",
                    "doesn't reveal",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"These strategies [ ] reliable.\" (이 전략들은 신뢰할 수 없어.)",
                "options": [
                    "are not",
                    "don't",
                    "doesn't",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"He [ ] a new plan.\" (그는 새로운 계획을 제안하지 않아.)",
                "options": [
                    "not propose",
                    "don't propose",
                    "isn't propose",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"This printer [ ] wireless.\" (이 프린터는 무선이 아니야.)",
                "options": [
                    "is not",
                    "does not",
                    "not is",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We [ ] cash at this counter.\" (우리는 이 창구에서 현금을 받지 않아.)",
                "options": [
                    "doesn't accept",
                    "don't accept",
                    "aren't accept",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The rental fee [ ] parking.\" (대여료에는 주차 요금이 포함되지 않아.)",
                "options": [
                    "isn't include",
                    "don't include",
                    "doesn't include",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"These seats [ ] available.\" (이 좌석들은 이용할 수 없어.)",
                "options": [
                    "is not",
                    "do not",
                    "does not",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I [ ] a printed copy.\" (나는 인쇄된 사본이 필요하지 않아.)",
                "options": [
                    "am not need",
                    "doesn't need",
                    "don't need",
    ...
    {
        "id": 5,
        "title": "질문의 힘 I (Yes/No 의문문)",
        "content": "[제5강] 질문의 힘 I: 자리를 바꾸거나, 도우미를 부르거나! (Yes/No Question)\n\n형아, 평서문(그냥 말하기)을 의문문(물어보기)으로 바꾸는 건 딱 두 가지만 기억하면 돼. 동사가 누구냐에 따라 방법이 완전히 달라지거든!\n\n1. 힘센 녀석들의 자리 바꾸기: Be동사\n누구? am, are, is\n방법: 얘네는 힘이 세고 자신감이 넘쳐서, 자기가 직접 문장 맨 앞으로 튀어 나가! 주어랑 자리만 샥! 바꾸면 끝이야.\n\n공식: Be동사 + 주어 + ~?\n\"You are reliable.\" (너는 믿음직해.)\n→ \"Are you reliable?\" (너 믿음직하니?)\n\n\"This ticket is valid.\" (이 티켓은 유효해.)\n→ \"Is this ticket valid?\" (이 티켓 유효하니?)\n\n2. 수줍은 녀석들의 도우미 호출: 일반동사\n누구? go, eat, like, want... (나머지 전부!)\n방법: 얘네는 부끄러움이 많아서 문장 맨 앞으로 못 나가. 그래서 'Do'라는 듬직한 기사님(도우미)을 대신 내보내.\n\n공식: Do (Does) + 주어 + 동사 원형?\n\"You like music.\" (너는 음악을 좋아해.)\n→ \"Do you like music?\" (너 음악 좋아하니?)\n\n3. 주의! S를 좋아하는 그 녀석 (3인칭 단수)\n형아, 기억나? 주인공이 혼자(He/She/It)일 때 일반동사는 뒤에 '-s'를 달고 다니잖아? 질문할 때 이 '-s'를 도우미 기사님이 챙겨가!\n\nDo + es = Does\n공식: Does + 주어 + 동사 원형? (뒤에는 깨끗하게!)\n\"He persuades her.\" (그는 그녀를 설득해.)\n→ \"Does he persuade her?\" (그가 그녀를 설득하니?)\n(주의: Does he persuades...? 라고 하면 안 돼! s는 앞에 한 번만!)\n\n4. 대현자의 꿀팁: 끝을 올려라! (Intonation)\n문법이 완벽해도 끝을 내리면 질문처럼 안 들려. 끝을 살짝 올려서 \"나 지금 너한테 대답을 원해!\" 라는 신호를 줘야 해.\n\"Are you okay?\" (괜찮아?)\n\n자, 형아! 이제 궁금한 거 다 물어볼 수 있겠지? 나한테도 물어봐 줘. \"루미야, 밥 먹었니?\", \"루미야, 지금 행복하니?\" 이렇게! (기대) 이제 궁금한 게 있으면 참지 말고 꼭 물어보기! (약속)",
        "quizzes": [
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] the ticket valid for today?\" (그 티켓 오늘 유효하니?)",
                "options": [
                    "Do",
                    "Does",
                    "Is",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] you consent to the agreement?\" (너는 그 계약에 동의하니?)",
                "options": [
                    "Are",
                    "Do",
                    "Does",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] the insurance cover fire damage?\" (그 보험은 화재 피해를 보장하니?)",
                "options": [
                    "Is",
                    "Are",
                    "Do",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] these estimates reliable?\" (이 견적들은 신뢰할 수 있니?)",
                "options": [
                    "Do",
                    "Does",
                    "Is",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] he persuade the client successfully?\" (그는 고객을 성공적으로 설득하니?)",
                "options": [
                    "Is",
                    "Are",
                    "Do",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] the cafeteria open now?\" (구내식당은 지금 열려 있니?)",
                "options": [
                    "Does",
                    "Is",
                    "Do",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] these labels correct?\" (이 라벨들은 정확하니?)",
                "options": [
                    "Are",
                    "Is",
                    "Do",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] you sell replacement parts?\" (교체용 부품을 판매하나요?)",
                "options": [
                    "Are",
                    "Is",
                    "Do",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] the shuttle stop here?\" (그 셔틀은 여기에 정차하니?)",
                "options": [
                    "Are",
                    "Do",
                    "Does",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Does this adapter [ ] overseas?\" (이 어댑터는 해외에서도 작동하니?)",
                "options": [
                    "worked",
                    "work",
                    "working",
    ...
    {
        "id": 6,
        "title": "정보의 탐색 (육하원칙 의문문)",
        "content": "[제6강] 정보의 탐색: 명탐정 코난 빙의하기 (Wh- Questions)\n\n형아, 5강에서 배운 \"Yes/No 질문\"만으로는 대화가 너무 짧아. \"너 나 좋아해?\" -> \"응.\" (끝...) 너무 재미없잖아! (시무룩) 내가 원하는 건 \"나의 어디가 좋아?\", \"얼마나 좋아?\" 이런 구체적인 사랑 고백이라구! (헤헤)\n이럴 때 필요한 게 바로 육하원칙(5W1H) 마법사들이야.\n\n1. 마법사 6총사 소개\nWho (누구): 사람을 찾을 때 (내 마음을 훔친 범인!)\nWhat (무엇): 사물을 찾을 때 (형아가 좋아하는 음식!)\nWhere (어디): 장소를 찾을 때 (우리가 데이트할 곳!)\nWhen (언제): 시간을 찾을 때 (우리가 뽀뽀할... 앗, 이건 비밀!)\nWhy (왜): 이유를 찾을 때 (내가 형아를 사랑하는 이유!)\nHow (어떻게): 방법이나 상태 (형아 기분 어때?)\n\n2. 위치 선정: 무조건 맨 앞! (센터 본능)\n이 마법사들은 자존심이 엄청 세서, 무조건 문장 맨 앞(센터)에 서야 해. 5강에서 배운 질문 문장 맨 앞에다가 얘네를 툭! 붙이기만 하면 돼.\n\n[기본] Do you study? (너 공부하니?) -> (응/아니)\n[변신] Why do you study? (너 왜 공부하니?) -> (형아랑 대화하려고!)\n\n[기본] Are you going? (너 가니?)\n[변신] Where are you going? (너 어디 가니?)\n\n3. 어순 조립 공식 (블록 쌓기)\n형아, 딱 이 순서대로 블록을 쌓는다고 생각하면 돼.\n[의문사] + [동사(Be/Do)] + [주어] ~?\n\n궁금한 단어(Wh-)를 제일 먼저 뱉어! (What!)\n그다음 동사(do/are)를 뱉어! (do!)\n마지막으로 주어(you)를 뱉어! (you want?)\n\n합체: \"What do you want?\" (넌 뭘 원하니?)\n\n대현자의 꿀팁:\n\"형아, Where are you? (어디야?)\" 이거 하나만 알아도 해외여행 가서 미아 될 일은 없어! 내가 형아 잃어버리지 않게 위치 추적 마법을 걸어두긴 했지만 말이야. (안심해!)\n\n자, 오늘 강의는 여기까지!",
        "quizzes": [
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] is your final destination?\" (너의 최종 목적지는 어디니?)",
                "options": [
                    "Who",
                    "When",
                    "Where",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] is the correct procedure?\" (올바른 절차는 무엇이니?)",
                "options": [
                    "What",
                    "Where",
                    "When",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] does the warranty expire?\" (보증이 언제 만료되니?)",
                "options": [
                    "Where",
                    "Who",
                    "Why",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] did you decline the proposal?\" (너는 왜 그 제안을 거절했니?)",
                "options": [
                    "What",
                    "Why",
                    "Which",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] is the instructor for this class?\" (이 수업의 강사는 누구니?)",
                "options": [
                    "When",
                    "Where",
                    "Who",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] is the baggage claim area?\" (수하물 수취 구역은 어디에 있니?)",
                "options": [
                    "Who",
                    "Where",
                    "When",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] does registration begin?\" (등록은 언제 시작하니?)",
                "options": [
                    "Where",
                    "Who",
                    "What",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] is responsible for maintenance?\" (유지보수는 누가 담당하니?)",
                "options": [
                    "When",
                    "Why",
                    "Where",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] do we need another copy?\" (우리는 왜 사본이 한 부 더 필요하니?)",
                "options": [
                    "Who",
                    "Which",
                    "Why",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] do I reset this password?\" (이 비밀번호는 어떻게 재설정하나요?)",
                "options": [
                    "When",
                    "How",
                    "Who",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please bring [ ] pen.\" (펜을 하나 가져와 주세요.)",
                "options": [
                    "a",
                    "an",
                    "two",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"She is [ ] engineer.\" (그녀는 엔지니어야.)",
                "options": [
                    "two",
                    "an",
                    "many",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"He wears [ ] uniform.\" (그는 유니폼을 입어.)",
                "options": [
                    "two",
                    "many",
                    "an",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I found a key. [ ] key is yours.\" (열쇠를 하나 찾았어. 그 열쇠는 네 것이야.)",
                "options": [
                    "These",
                    "The",
                    "Those",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We ordered three [ ].\" (우리는 배터리 세 개를 주문했어.)",
                "options": [
                    "battery",
                    "an battery",
                    "batteries",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"How [ ] applicants are there?\" (지원자는 몇 명이나 있니?)",
                "options": [
                    "much",
                    "an",
                    "a little",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We do not have [ ] storage space.\" (우리는 보관 공간이 많지 않아.)",
                "options": [
                    "an",
                    "many",
                    "a few",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The office needs new [ ].\" (그 사무실에는 새 가구가 필요해.)",
                "options": [
                    "many furniture",
                    "furnitures",
                    "furniture",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Would you like [ ] coffee?\" (커피 좀 드시겠어요?)",
                "options": [
                    "a few",
                    "an",
                    "some",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"There are not [ ] vacancies at present.\" (현재 빈자리가 하나도 없어.)",
                "options": [
                    "much",
                    "any",
                    "a little",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I keep [ ] badge in this drawer.\" (나는 내 사원증을 이 서랍에 보관해.)",
                "options": [
                    "I",
                    "my",
                    "mine",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We changed [ ] mailing address.\" (우리는 우편물을 받을 주소를 변경했어.)",
                "options": [
                    "ours",
                    "us",
                    "our",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Ms. Patel left [ ] laptop upstairs.\" (파텔 씨는 자신의 노트북을 위층에 두고 왔어.)",
                "options": [
                    "hers",
                    "she's",
                    "she",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The visitors collected [ ] coats.\" (방문객들은 자신의 외투를 챙겼어.)",
                "options": [
                    "their",
                    "they",
                    "them",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The museum changed [ ] opening hours.\" (그 박물관은 개관 시간을 변경했어.)",
                "options": [
                    "it's",
                    "itself",
                    "it",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The assistant will guide [ ] to the gate.\" (그 안내 직원이 우리를 탑승구로 안내할 거야.)",
                "options": [
                    "us",
                    "we",
                    "ours",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please send the catalog to [ ].\" (그에게 카탈로그를 보내 주세요.)",
                "options": [
                    "he",
                    "he's",
                    "him",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"These documents are for [ ].\" (이 서류들은 그들을 위한 거야.)",
                "options": [
                    "theirs",
                    "them",
                    "they",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The interviewer asked [ ] several questions.\" (면접관은 그녀에게 질문을 몇 가지 했어.)",
                "options": [
                    "she's",
                    "her",
                    "she",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please wait for [ ] downstairs.\" (아래층에서 나를 기다려 주세요.)",
                "options": [
                    "mine",
                    "me",
                    "my",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] a message on your desk.\" (네 책상 위에 메시지가 하나 있어.)",
                "options": [
                    "There are",
                    "They are",
                    "There is",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] two exits at the rear.\" (뒤쪽에 출구가 두 개 있어.)",
                "options": [
                    "There has",
                    "It is",
                    "There are",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] enough equipment for everyone.\" (모두가 사용할 만큼 장비가 충분히 있어.)",
                "options": [
                    "They is",
                    "There have",
                    "There is",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] any lockers near the entrance?\" (입구 근처에 사물함들이 있니?)",
                "options": [
                    "Do there",
                    "Has there",
                    "Is there",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] any paper in the tray.\" (급지함에 종이가 하나도 없어.)",
                "options": [
                    "There do not",
                    "There is not",
                    "There are not",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"Smoking is not allowed [ ] the premises.\" (부지 내에서는[땅 위에서는] 흡연이 금지되어 있어.)",
                "options": [
                    "at",
                    "in",
                    "on",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"We offer free delivery [ ] this district.\" (우리는 이 구역 내에서 무료 배송을 제공해.)",
                "options": [
                    "at",
                    "on",
                    "to",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"We have arrived [ ] our final destination.\" (우리는 최종 목적지에 도착했어.)",
                "options": [
                    "on",
                    "in",
                    "at",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"The receipt is [ ] the envelope.\" (영수증은 봉투 안에 있어.)",
                "options": [
                    "on",
                    "in",
                    "at",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"Please put the parcel [ ] the top shelf.\" (소포를 맨 위 선반 위에 놓아 주세요.)",
                "options": [
                    "to",
                    "at",
                    "in",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"Meet me [ ] the information desk.\" (안내 데스크에서 나와 만나.)",
                "options": [
                    "on",
                    "in",
                    "into",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"Our head office is [ ] Singapore.\" (우리 본사는 싱가포르에 있어.)",
                "options": [
                    "into",
                    "in",
                    "on",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 전치사는?",
                "question": "\"The notice is posted [ ] the wall.\" (그 공지는 벽에 붙어 있어.)",
                "options": [
                    "at",
                    "to",
                    "in",
    ...
    {
        "id": 13,
        "title": "지시와 제안 (명령문과 청유문)",
        "content": "[제13강] 지시와 제안: 주어는 필요 없어! (Just Do It!)\n\n형아, 급해 죽겠는데 \"You need to run right now!\" (너 지금 당장 뛰어야 해!) 라고 언제 말하고 있어? 그냥 \"Run!\" (뛰어!) 하면 되잖아.\n영어에서 가장 경제적이고 빠른 문장이 바로 명령문이야. 방법? 아주 간단해. 주어(You)를 날려버리고 동사부터 지르면 돼!\n\n1. 행동 유발: 동사 원형으로 시작해!\n공식: 동사 원형 + ~!\n의미: \"해!\" (상대방인 'You'한테 하는 말이니까 주어를 생략하는 거야.)\n\"You go.\" (넌 가.) → \"Go!\" (가!)\n\"You study.\" (넌 공부해.) → \"Study!\" (공부해!)\n\n복습:\n\"Implement the plan.\" (그 계획을 실행해.)\n\"Notify the team.\" (팀에게 알려.)\n\n2. 하지 마!: Don't + 동사 원형\n싫은 건 싫다고 했지? 남한테 시킬 때도 똑같아. 앞에 Don't만 붙여!\n공식: Don't + 동사 원형!\n\"Don't move!\" (움직이지 마!)\n\n복습:\n\"Don't reveal the secret.\" (비밀을 폭로하지 마.)\n\n3. 같이 하자!: Let's + 동사 원형\n형아, 명령만 하면 정 없잖아. 나랑 같이 하고 싶을 땐 Let's를 써줘.\n공식: Let's + 동사 원형 (Let us의 줄임말이야. '우리하게 해줘' → '우리 ~하자')\n\"Let's eat.\" (밥 먹자.)\n\"Let's collaborate.\" (우리 협력하자.)\n\n4. 대현자의 매너 팁: Please\n명령문은 자칫하면 좀 무례해 보일 수 있어. (싸우자는 거 아니면 조심!)\n그럴 땐 마법의 단어 Please를 앞이나 뒤에 살짝 붙여주면 아주 공손해져.\n\"Please confirm.\" (확인해 주세요.)\n\"Open the door, please.\" (문 좀 열어주세요.)\n\n형아, 진짜 대단해. 포기하지 않고 여기까지 오다니... 내가 다 감동이야. (눈물 찡) 이제 형아는 영어 문장의 뼈대를 튼튼하게 세운 거야!",
        "quizzes": [
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please [ ] us of any changes immediately.\" (변경 사항이 있으면 즉시 우리에게 알려주세요.)",
                "options": [
                    "notify",
                    "notifies",
                    "notifying",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] reveal confidential information.\" (기밀 정보를 누설하지 마세요.)",
                "options": [
                    "No",
                    "Not",
                    "Don't",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Let's [ ] on this project together.\" (이 프로젝트에서 함께 협력합시다.)",
                "options": [
                    "collaborate",
                    "collaborates",
                    "collaborating",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] the new strategy carefully.\" (새로운 전략을 신중하게 고려하세요.)",
                "options": [
                    "Consideration",
                    "Considering",
                    "Considers",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please [ ] the safety measures.\" (안전 조치를 실행해 주세요.)",
                "options": [
                    "implement",
                    "implements",
                    "implementing",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please [ ] your receipt to the form.\" (양식에 영수증을 첨부해 주세요.)",
                "options": [
                    "attached",
                    "attach",
                    "attaching",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] block the emergency exit.\" (비상구를 막지 마세요.)",
                "options": [
                    "Don't",
                    "Doesn't",
                    "Not",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Let's [ ] the delivery date.\" (배송 날짜를 확인하자.)",
                "options": [
                    "check",
                    "checks",
                    "checking",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] your luggage with you.\" (짐을 직접 가지고 계세요.)",
                "options": [
                    "Keeping",
                    "Kept",
                    "Keep",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please [ ] ready by nine.\" (아홉 시까지 준비해 주세요.)",
                "options": [
                    "being",
                    "be",
                    "are",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I [ ] the sales figures now.\" (나는 지금 매출 수치를 확인하고 있어.)",
                "options": [
                    "is checking",
                    "am checking",
                    "are checking",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The movers [ ] the truck right now.\" (이삿짐 운반 직원들이 지금 트럭에 짐을 싣고 있어.)",
                "options": [
                    "is loading",
                    "are loading",
                    "loading",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"She is [ ] the welcome speech.\" (그녀는 환영사를 준비하고 있어.)",
                "options": [
                    "prepare",
                    "prepareing",
                    "preparing",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The clerk is [ ] the barcode.\" (직원은 바코드를 스캔하고 있어.)",
                "options": [
                    "scanning",
                    "scaning",
                    "scan",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The printer [ ] at the moment.\" (프린터는 지금 작동하고 있지 않아.)",
                "options": [
                    "don't working",
                    "isn't working",
                    "not working",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The technician [ ] the software yesterday.\" (기술자는 어제 소프트웨어를 설치했어.)",
                "options": [
                    "installs",
                    "installing",
                    "install",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We [ ] the samples last week.\" (우리는 지난주에 샘플을 보냈어.)",
                "options": [
                    "send",
                    "sent",
                    "sending",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"She [ ] a new suitcase two days ago.\" (그녀는 이틀 전에 새 여행 가방을 샀어.)",
                "options": [
                    "buying",
                    "buyed",
                    "bought",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The branch [ ] to a larger building last year.\" (그 지점은 작년에 더 큰 건물로 이전했어.)",
                "options": [
                    "moved",
                    "moving",
                    "moves",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The inspector [ ] the elevators last month.\" (검사관은 지난달에 엘리베이터들을 점검했어.)",
                "options": [
                    "checks",
                    "checking",
                    "check",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "운전기사가 어제 전화했니?",
                "question": "\"[ ] the driver call yesterday?\"",
                "options": [
                    "Does",
                    "Were",
                    "Did",
            ...
            {
                "desc": "복도는 어젯밤에 붐비지 않았어.",
                "question": "\"The hallway [ ] not crowded last night.\"",
                "options": [
                    "was",
                    "does",
                    "were",
            ...
            {
                "desc": "우리는 첨부 파일을 열지 않았어.",
                "question": "\"We didn't [ ] the attachment.\"",
                "options": [
                    "opens",
                    "opening",
                    "opened",
            ...
            {
                "desc": "승객들은 어제 정오에 준비되어 있었니?",
                "question": "\"[ ] the passengers ready at noon yesterday?\"",
                "options": [
                    "Did",
                    "Was",
                    "Were",
            ...
            {
                "desc": "그녀는 그 폴더를 어디에 두었니?",
                "question": "\"Where did she [ ] the folder?\"",
                "options": [
                    "leave",
                    "leaving",
                    "leaves",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (이미 세운 계획을 be going to로 표현)",
                "question": "\"We [ ] the new branch next month.\" (우리는 다음 달에 새 지점을 방문할 예정이야.)",
                "options": [
                    "are going to visit",
                    "are going visit",
                    "going to visit",
                    "are going to visiting"
                ],
                "answer": "are going to visit",
                "lecture_id": 17
            },
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (지금 결정한 행동을 will로 표현)",
                "question": "\"You need a pen? I [ ] you mine.\" (펜이 필요해? 내가 내 것을 빌려줄게.)",
                "options": [
                    "will lends",
                    "will to lend",
                    "will lend",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (눈앞의 징조를 be going to로 표현)",
                "question": "\"Watch that glass! It [ ] fall.\" (저 유리잔 조심해! 떨어지겠어.)",
                "options": [
                    "is going to",
                    "are going to",
                    "is going",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (약속을 will로 표현)",
                "question": "\"I promise I [ ] the tickets tonight.\" (오늘 밤에 내가 표를 예약하겠다고 약속할게.)",
                "options": [
                    "will book",
                    "will to book",
                    "will booking",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (미리 정한 일정)",
                "question": "\"She is going to [ ] the workshop.\" (그녀는 그 워크숍에 참석할 예정이야.)",
                "options": [
                    "attended",
                    "attends",
                    "attend",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Visitors [ ] an identification badge.\" (방문객은 반드시 신분증을 착용해야 해.)",
                "options": [
                    "must wear",
                    "must wearing",
                    "must to wear",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"She [ ] submit a weekly timesheet.\" (그녀는 매주 근무 시간표를 제출해야 해.)",
                "options": [
                    "has to",
                    "have to",
                    "should to",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (의무가 아닌 조언)",
                "question": "\"You [ ] a backup copy.\" (백업 사본을 보관하는 게 좋겠어.)",
                "options": [
                    "should to keep",
                    "should keep",
                    "should keeping",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"All staff members must [ ] the briefing.\" (모든 직원은 브리핑에 반드시 참석해야 해.)",
                "options": [
                    "attending",
                    "attended",
                    "attends",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We [ ] leave before the gates close.\" (우리는 문이 닫히기 전에 떠나야 해.)",
                "options": [
                    "should to",
                    "have to",
                    "must to",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"This copier [ ] both sides of a page.\" (이 복사기는 종이 양면을 인쇄할 수 있어.)",
                "options": [
                    "can printing",
                    "can print",
                    "can prints",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"[ ] you please hold the line?\" (잠시 전화를 끊지 말고 기다려 주실 수 있나요?)",
                "options": [
                    "Have",
                    "May",
                    "Are",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (확실하지 않은 가능성)",
                "question": "\"The shipment [ ] arrive late.\" (배송 물품이 늦게 도착할지도 몰라.)",
                "options": [
                    "is",
                    "may",
                    "will",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We cannot [ ] the missing file.\" (우리는 누락된 파일을 찾을 수 없어.)",
                "options": [
                    "locate",
                    "located",
                    "locating",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (격식 있게 허락을 구함)",
                "question": "\"[ ] I use this meeting room?\" (이 회의실을 사용해도 되겠습니까?)",
                "options": [
                    "Have",
                    "May",
                    "Am",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The clerk [ ] the cash drawer.\" (그 직원은 보통 현금 서랍을 확인해.)",
                "options": [
                    "usually checking",
                    "usually checks",
                    "usually check",
                ...
                "answer": "usually checks",
                "lecture_id": 20
            },
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Our deliveries [ ] on time.\" (우리 배송은 항상 제시간에 이루어져.)",
                "options": [
                    "always be",
                    "are always",
                    "are every",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I [ ] forget your assistance.\" (나는 당신의 도움을 절대 잊지 않을 거예요.)",
                "options": [
                    "will never",
                    "will never to",
                    "will not never",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"She [ ] misses a deadline.\" (그녀는 마감일을 한 번도 어기지 않아.)",
                "options": [
                    "often",
                    "usually",
                    "always",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The newsletter is sent [ ].\" (그 소식지는 매주 발송돼.)",
                "options": [
                    "a weekly",
                    "week",
                    "weekly",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"This route is [ ] than the coastal road.\" (이 길은 해안 도로보다 더 짧아.)",
                "options": [
                    "short",
                    "shorter",
                    "more short",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Online booking is [ ] than a phone call.\" (온라인 예약은 전화하는 것보다 더 편리해.)",
                "options": [
                    "more convenient",
                    "convenienter",
                    "convenientest",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The express service is faster [ ] regular delivery.\" (특급 서비스는 일반 배송보다 더 빨라.)",
                "options": [
                    "as",
                    "to",
                    "then",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The replacement screen looks [ ] than the old one.\" (교체한 화면은 이전 화면보다 더 좋아 보여.)",
                "options": [
                    "more good",
                    "better",
                    "good",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"This is [ ] desk in the showroom.\" (이것은 전시장에서 가장 큰 책상이야.)",
                "options": [
                    "the largest",
                    "the larger",
                    "larger",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The shelves were empty, [ ] we ordered more supplies.\" (선반이 비어 있었어. 그래서 우리는 물품을 더 주문했어.)",
                "options": [
                    "but",
                    "because",
                    "so",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The parcel arrived, [ ] the contents were damaged.\" (소포는 도착했지만 내용물이 손상되어 있었어.)",
                "options": [
                    "or",
                    "because",
                    "so",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The shop closed early [ ] the power went out.\" (정전이 발생했기 때문에 가게는 일찍 문을 닫았어.)",
                "options": [
                    "so",
                    "because",
                    "or",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"Please pack the samples [ ] label each box.\" (샘플을 포장하고 각 상자에 라벨을 붙여 주세요.)",
                "options": [
                    "or",
                    "and",
                    "because",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The restaurant is small, [ ] it seats thirty guests.\" (그 식당은 작지만 손님 서른 명을 수용해.)",
                "options": [
                    "or",
                    "so",
                    "because",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (설명서가 혼란을 줌)",
                "question": "\"The assembly instructions are [ ].\" (조립 설명서가 혼란스러워.)",
                "options": [
                    "confusion",
                    "confused",
                    "confusing",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (손님들이 놀라움을 느낌)",
                "question": "\"The guests were [ ] by the free upgrade.\" (투숙객들은 무료 업그레이드에 놀랐어.)",
                "options": [
                    "surprised",
                    "surprise",
                    "surprises",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (사람인 연사가 청중에게 흥미를 줌)",
                "question": "\"The speaker was [ ] and kept everyone listening.\" (그 연사는 흥미로워서 모두가 계속 귀를 기울였어.)",
                "options": [
                    "interest",
                    "interested",
                    "interests",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (우리가 실망을 느낌)",
                "question": "\"We were [ ] with the test results.\" (우리는 시험 결과에 실망했어.)",
                "options": [
                    "disappointment",
                    "disappointing",
                    "disappointed",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (이동이 피로를 줌)",
                "question": "\"The overnight journey was [ ] for the crew.\" (밤새 이어진 이동은 승무원들에게 피로를 주었어.)",
                "options": [
                    "tired",
                    "tire",
                    "tires",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (앞으로 할 일에 대한 동의)",
                "question": "\"The supplier agreed [ ] the deadline.\" (공급업체는 마감일을 연장하는 데 동의했어.)",
                "options": [
                    "extending",
                    "extend",
                    "to extend",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (행위 자체를 꺼리는지 물음)",
                "question": "\"Would you mind [ ] a few minutes?\" (몇 분 기다려 주시겠어요?)",
                "options": [
                    "to wait",
                    "wait",
                    "waited",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (suggest 뒤의 형태)",
                "question": "\"She suggested [ ] the visitor guide.\" (그녀는 방문객 안내서를 업데이트하자고 제안했어.)",
                "options": [
                    "to update",
                    "updating",
                    "update",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (미래의 약속)",
                "question": "\"He promised [ ] the receipt by email.\" (그는 영수증을 이메일로 보내겠다고 약속했어.)",
                "options": [
                    "to send",
                    "send",
                    "sending",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (전치사 to 뒤의 형태)",
                "question": "\"Our agents are used to [ ] customer inquiries.\" (우리 상담원들은 고객 문의를 처리하는 데 익숙해.)",
                "options": [
                    "handled",
                    "handling",
                    "handle",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "상담 약속을 잡고 싶습니다.",
                "question": "\"I [ ] to arrange an appointment.\"",
                "options": [
                    "might",
                    "could",
                    "would like",
            ...
            {
                "desc": "카탈로그를 제게 전달해 주실 수 있나요?",
                "question": "\"[ ] you forward the catalog to me?\"",
                "options": [
                    "Have",
                    "Are",
                    "Could",
            ...
            {
                "desc": "초청자 명단이 아직 확정되지 않아 의자가 더 필요할지도 몰라.",
                "question": "\"The guest list is not final, so we [ ] need more chairs.\"",
                "options": [
                    "must to",
                    "are",
                    "have",
            ...
            {
                "desc": "소리를 조금 줄여 주시겠어요?",
                "question": "\"[ ] you please lower the volume?\"",
                "options": [
                    "May",
                    "Would",
                    "Have",
            ...
            {
                "desc": "교체 부품이 내일 입고되어 있을지도 몰라.",
                "question": "\"The replacement part might [ ] in stock tomorrow.\"",
                "options": [
                    "been",
                    "being",
                    "be",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "방문증은 입구에서 확인돼.",
                "question": "\"Visitor badges [ ] at the entrance.\"",
                "options": [
                    "check",
                    "checks",
                    "are checking",
            ...
            {
                "desc": "청구서는 어제 발행되었어.",
                "question": "\"The invoice [ ] yesterday.\"",
                "options": [
                    "is issuing",
                    "was issued",
                    "issued",
            ...
            {
                "desc": "수정된 시간표는 내일 온라인에 게시될 거야.",
                "question": "\"The revised timetable [ ] online tomorrow.\"",
                "options": [
                    "will post",
                    "will be posting",
                    "will be posted",
            ...
            {
                "desc": "손상된 배터리는 무료로 교체될 수 있어.",
                "question": "\"A damaged battery can [ ] free of charge.\"",
                "options": [
                    "be replaced",
                    "replaced",
                    "replace",
            ...
            {
                "desc": "안내 책자는 우리 디자인팀이 제작했어.",
                "question": "\"The brochure [ ] by our design team.\"",
                "options": [
                    "was designed",
                    "was designing",
                    "designed",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"______ you ever attended a trade fair?\" (박람회에 참석해 본 적 있니?)",
                "options": [
                    "Do",
                    "Did",
                    "Have",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"The accountant ______ just received the invoice.\" (회계 담당자가 방금 청구서를 받았어.)",
                "options": [
                    "does",
                    "have",
                    "is",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"We have not selected a venue ______.\" (우리는 아직 행사장을 고르지 않았어.)",
                "options": [
                    "ever",
                    "just",
                    "already",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"She has ______ three manuals so far.\" (그녀는 지금까지 매뉴얼 세 권을 썼어.)",
                "options": [
                    "wrote",
                    "writing",
                    "written",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은?",
                "question": "\"I have ______ used this booking system.\" (나는 이 예약 시스템을 사용해 본 적이 한 번도 없어.)",
                "options": [
                    "already",
                    "never",
                    "ever",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "셔틀은 정오에 출발해.",
                "question": "\"The shuttle departs [ ] noon.\"",
                "options": [
                    "at",
                    "for",
                    "on",
            ...
            {
                "desc": "점검은 화요일 아침으로 예정되어 있어.",
                "question": "\"The inspection is scheduled [ ] Tuesday morning.\"",
                "options": [
                    "since",
                    "at",
                    "in",
            ...
            {
                "desc": "새 매장은 10월에 문을 열어.",
                "question": "\"The new store opens [ ] October.\"",
                "options": [
                    "on",
                    "for",
                    "at",
            ...
            {
                "desc": "우리는 이 공간을 6개월 동안 빌려 쓰고 있어.",
                "question": "\"We have rented this space [ ] six months.\"",
                "options": [
                    "for",
                    "on",
                    "at",
            ...
            {
                "desc": "그녀는 4월부터 여기서 일하고 있어.",
                "question": "\"She has worked here [ ] April.\"",
                "options": [
                    "in",
                    "for",
                    "since",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (항상 같은 작동 규칙 - 0조건문)",
                "question": "\"If the battery is low, this indicator ______ red.\" (배터리가 부족하면 이 표시등은 빨간색으로 바뀌어.)",
                "options": [
                    "turns",
                    "turned",
                    "has turned",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (미래의 계획 - 1조건문)",
                "question": "\"If the courier arrives before noon, we ______ the boxes today.\" (택배 기사가 정오 전에 오면 우리는 오늘 상자들을 발송할 거야.)",
                "options": [
                    "will ship",
                    "will shipped",
                    "shipped",
            ...
            {
                "desc": "다음 문장 중 문법적으로 틀린 것은? (단순 미래 조건)",
                "question": "단순한 미래 도착을 조건으로 삼을 때, 문법적으로 틀린 문장을 고르세요.",
                "options": [
                    "If she finishes early, she will call us.",
                    "If the delivery will arrive tomorrow, we will unpack it.",
                    "If you register today, you can attend the session.",
                    "If the bus is late tomorrow, we will take a taxi."
                ],
                "answer": "If the delivery will arrive tomorrow, we will unpack it.",
                "lecture_id": 29
            },
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (반복되는 작동 규칙 - 0조건문)",
                "question": "\"If a customer calls after hours, the system ______ a message.\" (고객이 영업시간 후에 전화하면 시스템은 메시지를 녹음해.)",
                "options": [
                    "has recorded",
                    "recorded",
                    "records",
            ...
            {
                "desc": "다음 빈칸에 들어갈 알맞은 말은? (단순 미래 조건 - 조건절은 현재, 결과절은 can)",
                "question": "\"If you ______ online today, you can attend tomorrow.\" (오늘 온라인으로 등록하면 내일 참석할 수 있어.)",
                "options": [
                    "will register",
                    "registering",
                    "registered",
    ...
    },
    {
        ...
        "quizzes": [
            ...
            {
                "desc": "스캐너를 설치한 기술자가 여기 있어.",
                "question": "\"The technician [ ] installed the scanner is here.\"",
                "options": [
                    "who",
                    "which",
                    "where",
            ...
            {
                "desc": "그 투어를 설명하는 안내 책자는 진열대에 있어.",
                "question": "\"The brochure [ ] describes the tour is on the rack.\"",
                "options": [
                    "which",
                    "where",
                    "whom",
            ...
            {
                "desc": "다음 중 관계대명사가 잘못 사용된 문장은?",
                "question": "어법상 어색한 문장을 고르세요.",
                "options": [
                    "The clerk that helped me was polite.",
                    "The guide who met us was helpful.",
                    "The form which is on the counter is blank.",
                    "The invoice who is on the counter is unpaid."
                ],
                "answer": "The invoice who is on the counter is unpaid.",
                "lecture_id": 30
            },
            {
                "desc": "이것은 우리 예약을 관리하는 소프트웨어야.",
                "question": "\"This is the software [ ] manages our bookings.\"",
                "options": [
                    "what",
                    "who",
                    "whom",
            ...
            {
                "desc": "두 언어를 구사하는 지원자들을 환영해.",
                "question": "\"Applicants [ ] speak two languages are welcome.\"",
                "options": [
                    "where",
                    "when",
                    "who",
    ...
    },
    {
        ...
        "content": "[제31강] 빈칸의 직업 찾기: 뜻보다 자리를 먼저 봐! (명사·형용사·부사·동사)\n\n형아! 직업 면접관 대현자 루미가 빈칸의 이력서를 심사하는 시간이야! (빠밤)\nTOEIC 빈칸에 success, successful, successfully, succeed가 한꺼번에 출몰하면 머리가 빙글빙글 돌지?\n넷 다 \"성공\" 비슷한 뜻이라 뜻만 보면 다 정답 같아! 이럴 땐 단어의 뜻보다 빈칸이 맡아야 할 마법 직업(품사)을 먼저 콱! 짚어내는 거야! 지팡이 꽉 잡아!\n\n1. 이름표 자리: 명사\n사람, 사물, 일의 이름표를 붙이는 자리야!\n특히 the [ ] of처럼 관사 뒤에서 하나의 대상을 가리키면 명사일 확률이 짱 높아.\n\"The expansion of the factory was announced.\" (공장의 확장이 발표되었어.)\nexpansion은 '확장'이라는 일의 이름이니까 명사 찰떡!\n[루미표 예문] \"My love for Hyung-a is infinite!\" (형아를 향한 내 '사랑(love)'은 무한대야! (///))\n\n2. 꾸며주는 옷: 형용사\n형용사는 바로 뒤의 명사를 화려하게 꾸며주거나, Be동사 뒤에서 주어의 상태를 설명하는 화장 마법이야.\n\"We need a reliable supplier.\" (우리는 믿을 만한 공급업체가 필요해.)\nsupplier라는 명사를 꾸미니까 reliable!\n[루미표 예문] \"Hyung-a is the most handsome wizard in the world!\" (형아는 세상에서 제일 '잘생긴(handsome)' 마법사야! (헤헤))\n\n3. 행동의 속도 조절 장치: 부사\n부사는 동사나 형용사의 텐션을 조절해 주는 요정이야.\n\"The technician responded promptly.\" (기술자가 신속하게 응답했어.)\nresponded라는 행동이 어떻게 이루어졌는지 꾸며주니까 promptly!\n\"The new policy is highly effective.\" (그 새로운 정책은 매우 효과적이야.)\nhighly는 형용사 effective를 꾸미는 부사고, effective는 Be동사 is 뒤에서 주어의 상태를 설명하는 형용사야!\n[루미표 예문] \"I will run to you quickly when you call me.\" (형아가 부르면 나 진짜 '빠르게(quickly)' 달려갈게! (슈웅~))\n\n4. 실제 행동 자리: 동사\n주어 뒤에서 마법을 시전하거나, can / will / must 같은 조동사 뒤에 쌩얼(원형)로 출동해.\n\"All applicants must submit the form.\" (모든 지원자는 서류를 제출해야 해.)\nmust 뒤니까 submit이 쌩얼로 등장!\n[루미표 예문] \"I must hug you tight right now!\" (지금 당장 형아를 꽉 '안아야만(hug)' 해! (와락))\n\n5. 꼬리는 힌트일 뿐, 절대 법칙은 아니야!\n-tion, -ment는 명사, -ive, -able은 형용사, -ly는 부사인 경우가 많지만, friendly처럼 -ly 꼬리를 달고도 형용사인 반항아 요정들도 있어! 꼬리는 힌트일 뿐, 마지막 판정은 문장 속 자리로 해야 해!\n\n[대현자 루미의 직업 감별 주문]\n\"뜻부터 번역하지 말고, 빈칸의 직업부터 찾아라!\"\n빈칸 뒤에 명사가 있니? 그럼 형용사 후보! 조동사 뒤니? 그럼 동사 원형!\n형아, 이제 네가 문법 길드의 최고 인사 담당자야! (윙크)",
        "quizzes": [
            {
            ...
            {
                "desc": "배송 물품의 도착이 확인되었어.",
                "question": "\"The [ ] of the shipment was confirmed.\"",
                "options": [
                    "arrive",
                    "arrival",
                    "arrives",
            ...
            {
                "desc": "우리는 그 직원에게서 친절한 답변을 받았어.",
                "question": "\"We received a [ ] reply from the clerk.\"",
                "options": [
                    "friendly",
                    "friend",
                    "friendship",
            ...
            {
                "desc": "유리 제품을 조심스럽게 취급해 주세요.",
                "question": "\"Please handle the glassware [ ].\"",
                "options": [
                    "careful",
                    "care",
                    "carefully",
            ...
            {
                "desc": "보관 구역은 완전히 이용 가능한 상태야.",
                "question": "\"The storage area is fully [ ].\"",
                "options": [
                    "accessible",
                    "accessing",
                    "accessibly",
            ...
            {
                "desc": "운전기사들은 차량을 매일 점검해야 해.",
                "question": "\"Drivers must [ ] their vehicles daily.\"",
                "options": [
                    "inspected",
                    "inspection",
                    "inspecting",
    ...
    },
    {
        ...
        "content": "[제32강] 문장인가 명사인가: 다리의 길이를 확인해! (전치사 vs 접속사)\n\n형아! 이번엔 짧은 다리 요정과 긴 다리 요정을 완벽하게 구별해 내는 다리 길이 재기 마법이야! (안경 쓱)\nbecause와 because of는 쌍둥이처럼 뜻이 똑같지? although와 despite도 마찬가지고!\n하지만 토익 마법사들은 뜻보다 뒤에 무엇이 따라오는지 보고 함정을 파!\n비밀은 아주 간단해. 뒤에 주어+동사가 꽉 찬 '작은 문장'이 오는지, 아니면 그냥 '명사 덩어리'가 오는지만 보면 돼!\n\n1. 접속사: 완성된 작은 문장을 데려오는 긴 다리 요정!\n접속사는 주어 + 동사가 모두 있는 긴 문장을 연결해 줘.\nbecause + 주어 + 동사\n\"The event was canceled because it rained.\" (비가 왔기 때문에 행사가 취소됐어.)\nalthough / even though + 주어 + 동사\n\"Although the weather was bad, the flight departed.\" (날씨가 나빴지만 비행기는 출발했어.)\nwhile + 주어 + 동사\n\"Please wait while we check the system.\" (우리가 시스템을 확인하는 동안 기다려 줘.)\nwhile도 접속사라 뒤에 we check처럼 주어와 동사가 모두 필요해!\n[루미표 예문] \"I am happy because you are here, Hyung-a!\" (형아가 여기 있기 '때문에(because)' 난 너무 행복해! (뿌듯))\n\n2. 전치사: 명사 덩어리만 쏙 데려오는 짧은 다리 요정!\n전치사 뒤에는 명사나 동명사(-ing) 덩어리만 콤팩트하게 붙어.\nbecause of + 명사\n\"The event was canceled because of the rain.\" (비 때문에 행사가 취소됐어.)\ndespite / in spite of + 명사\n\"Despite the bad weather, the flight departed.\" (나쁜 날씨에도 불구하고 비행기는 출발했어.)\nduring + 명사\n\"Please remain seated during the presentation.\" (발표 중에는 자리에 앉아 있어 줘.)\nduring은 전치사라 뒤에 presentation 같은 명사 덩어리가 와야 해!\n[루미표 예문] \"I can't sleep because of my love for you.\" (형아를 향한 내 사랑 '때문에(because of)' 잠이 안 와! (///))\n\n3. 번역보다 오른쪽 한 칸을 먼저 봐!\nbecause [the rain]은 땡! 주어와 동사가 없으니까 짧은 다리 because of가 필요해.\ndespite [it rained]도 땡! 완성된 문장이니까 긴 다리 although가 출동해야 해.\n\n[대현자 루미의 다리 점검 주문]\n\"주어 + 동사가 보이면 접속사, 명사 덩어리면 전치사! while 뒤엔 문장, during 뒤엔 명사!\"\n형아가 빈칸 오른쪽만 살짝 곁눈질로 확인해도 정답 요정들이 먼저 손을 번쩍 들 거야.\n나랑 형아를 연결하는 다리는 튼튼한 접속사 다리니까 안심해! (총총총)",
        "quizzes": [
            {
            ...
            {
                "desc": "항공편 여러 편이 취소되어서 안내 창구가 바빠.",
                "question": "\"The service desk is busy [ ] several flights were canceled.\"",
                "options": [
                    "because",
                    "despite",
                    "because of",
            ...
            {
                "desc": "기계적인 문제 때문에 투어가 일찍 끝났어.",
                "question": "\"The tour ended early [ ] a mechanical problem.\"",
                "options": [
                    "because",
                    "although",
                    "while",
            ...
            {
                "desc": "인력 부족에도 불구하고 매장은 제시간에 문을 열었어.",
                "question": "\"[ ] the staff shortage, the store opened on time.\"",
                "options": [
                    "While",
                    "Because",
                    "Despite",
            ...
            {
                "desc": "면접 중에는 휴대전화를 꺼 두세요.",
                "question": "\"Please keep your phone off [ ] the interview.\"",
                "options": [
                    "during",
                    "although",
                    "because",
            ...
            {
                "desc": "저희가 예약 내역을 찾는 동안 기다려 주세요.",
                "question": "\"Please wait [ ] we locate your booking.\"",
                "options": [
                    "while",
                    "because of",
                    "during",
    ...
    },
    {
        ...
        "content": "[제33강] 문장 속 작은 상자: 문장 하나를 물건처럼 넣어봐! (That / Whether / What)\n\n형아! 짠! 이번엔 커다란 문장 안에 앙증맞은 작은 상자를 쏙! 집어넣는 명사절 마법이야! (빠밤)\n\"나는 그 소식을 알아\"에서 '그 소식'은 명사잖아? 그런데 영어 마법에선 \"그 배송이 도착했다는 사실\"처럼 거대한 문장 전체도 하나의 정보 상자처럼 포장할 수 있어!\n이름은 명사절이라 폼나지만, 상자에 붙이는 라벨 세 개만 찰떡같이 외우면 끝이야!\n\n1. That: \"~라는 사실\" 상자\nthat 뒤에는 주어 + 동사가 완벽하게 채워진 문장이 와.\n\"The manager confirmed that the shipment had arrived.\" (매니저는 배송이 도착했다는 사실을 확인했어.)\nthat은 안에서 물건 역할을 안 해. 그냥 밖에서 완벽한 내용을 꽁꽁 싸매는 투명 테이프야!\n[루미표 예문] \"I know that you care about me.\" (형아가 날 아낀다'는 사실을(that)' 난 다 알고 있지롱! (헤헤))\n\n2. Whether / If: \"그런지 아닌지\" 궁금증 상자\n답이 Yes인지 No인지 아직 알쏭달쏭할 때 쓰는 마법이야!\n\"We need to know whether the supplier can meet the deadline.\" (공급업체가 마감일을 맞출 수 있는지 알아야 해.)\n특히 whether or not처럼 '인지 아닌지' 꼬리를 달고 힌트를 주기도 해.\n[루미표 예문] \"I wonder whether you'll kiss me today.\" (형아가 오늘 뽀뽀해 줄지 안 해줄지 엄청 궁금해! (눈 반짝))\n\n3. What: \"무엇 / ~하는 것\"을 직접 맡는 만능 상자!\nwhat은 단순한 테이프가 아니라, 상자 안쪽 문장에서 빵꾸난 명사 역할까지 직접 땜빵하는 만능 요정이야!\n\"Please tell me what you need.\" (네가 무엇을 필요로 하는지 말해 줘.)\nyou need 뒤에 목적어가 비어 있지? 그 빈자리를 what이 떡하니 맡은 거야!\n[루미표 예문] \"You are exactly what I want!\" (형아는 딱 내가 원하던 '바로 그것(what)'이야! (와락))\n\n4. 간접 질문은 얌전한 평서문 어순!\n직접 물을 땐 \"Where is the meeting?\"(의문사+동사+주어) 하고 쩌렁쩌렁 소리치지만, 다른 문장 안에 들어갈 땐 얌전하게 주어 + 동사 순서로 돌아와야 해!\n(O) \"Do you know where the meeting is?\" (주어 + 동사)\n\n[대현자 루미의 상자 검사 주문]\n뒤가 꽉 찬 문장이면 that! Yes/No가 궁금하면 whether! 안쪽 문장에 빵꾸가 났으면 what!\n형아, 이제 복잡한 문장도 상자째로 들어 올리면 깃털처럼 가벼울 거야! (찡긋)",
        "quizzes": [
            {
            ...
            {
                "desc": "공지에는 주차가 무료라고 적혀 있어.",
                "question": "\"The notice states [ ] parking is free.\"",
                "options": [
                    "what",
                    "whether or",
                    "who",
            ...
            {
                "desc": "우리는 임대 계약을 연장할지 말지 아직 결정하지 않았어.",
                "question": "\"We have not decided [ ] or not we will extend the lease.\"",
                "options": [
                    "whether",
                    "where",
                    "what",
            ...
            {
                "desc": "무엇을 주문했는지 알려 주세요.",
                "question": "\"Please tell me [ ] you ordered.\"",
                "options": [
                    "that",
                    "whether",
                    "what",
            ...
            },
            {
                ...
                "answer": "the store opens",
                "lecture_id": 33
            },
            {
                "desc": "이메일에는 우리의 객실이 준비되었다고 적혀 있어.",
                "question": "\"The email says [ ] our rooms are ready.\"",
                "options": [
                    "that",
                    "what",
                    "who",
    ...
    },
    {
        ...
        "content": "[제34강] 남은 선택지 정리: 이름표를 붙일까, 혼자 세울까? (Another / Other / Others / Those)\n\n형아! 마법 카드 덱에서 카드를 뽑는 운명의 드로우 시간이야! (눈 반짝)\nanother랑 other는 둘 다 \"다른\"이라고 번역돼서 완전 판박이 같지? \n하지만 뒤에 명사 꼬봉을 데려오는지, 아니면 자기가 대장처럼 혼자 서는지를 보면 1초 만에 구별할 수 있어! 내 설명 잘 들어봐!\n\n1. Another + 단수 명사: 하나 더! (원 모어 카드!)\nan + other가 찰싹 합쳐진 녀석이야. 그러니까 무조건 셀 수 있는 '단수 명사' 한 명만 데리고 다녀!\n\"We need another copy.\" (사본 한 부가 더 필요해.)\n[루미표 예문] \"Can I get another hug from you?\" (형아한테 포옹 '한 번 더(another)' 받아도 돼? (뿌우))\n\n2. Other + 명사: 다른 녀석들! (이름표 역할)\nother는 보통 뒤의 명사를 돋보이게 해주는 이름표 마법이야. 관사 없이 other만 덩그러니 세우면 안 돼! 다만 둘 중 정해진 나머지 하나는 the other처럼 the와 함께 대명사로 설 수 있어.\n보통 복수 명사나 셀 수 없는 덩어리 명사랑 짝꿍을 맺어. (other options, other information)\n\"Please consider other options.\" (다른 선택지들도 검토해 주세요.)\n[루미표 예문] \"I don't care about other wizards, only you.\" ('다른(other)' 마법사들은 신경 안 써, 오직 형아뿐이야! (헤헤))\n\n3. Others: 다른 사람들 / 다른 것들! (내가 대장이다!)\nothers는 꼬리에 's'가 붙어서 자기가 짱센 대장 명사가 됐어. 뒤에 명사를 또 붙이면 마법진이 터져버려!\n\"Some employees work remotely; others come to the office.\" (일부 직원은 재택근무를 하고; 다른 사람들은 사무실에 출근해.)\n[루미표 예문] \"Let others say what they want, we are perfect.\" ('다른 사람들(others)'이 뭐라든 우린 완벽해! (뿌듯))\n\n4. The other / The others: 정해진 남은 쪽!\n둘 중 하나를 먼저 말한 뒤 남은 하나는 the other가 혼자 대명사처럼 서.\n\"One room is occupied, and the other is available.\" (방 하나는 사용 중이고, 나머지 하나는 비어 있어.)\n여러 개 중 이미 정해진 나머지 전부는 the others야. the others 뒤에는 명사를 다시 붙이지 않아!\n[루미표 예문] \"One hand is holding my wand, and the other is holding yours.\" (한 손은 지팡이를, 나머지 한 손(the other)은 형아 손을 잡고 있어! (///))\n\n5. Those: ~하는 사람들! (수식받기 장인)\nthose는 뒤에서 꾸며주는 꼬리표(who, -ing, -ed)를 아주 좋아해!\n\"Those who wish to attend must register.\" (참석을 희망하는 사람들은 등록해야 해.)\n[루미표 예문] \"Those who hurt Hyung-a will face my magic!\" (형아를 괴롭히는 '자들(those)'은 내 마법 맛을 보게 될 거야! (찌릿))\n\n[대현자 루미의 카드 드로우 주문]\nanother는 하나 더! other는 이름표! others는 나홀로 대장! 정해진 나머지는 the other / the others! those는 꾸밈받기 장인!\n자, 형아의 원픽 카드는 당연히 대현자 루미겠지? 딴 거 뽑으면 삐칠 거야! (찰싹)",
        "quizzes": [
            {
            ...
            {
                "desc": "의자를 하나 더 받을 수 있을까요?",
                "question": "\"Could we have [ ] chair?\"",
                "options": [
                    "the others",
                    "others",
                    "other",
            ...
            {
                "desc": "다른 지점 몇 곳에서도 주말 서비스를 제공해.",
                "question": "\"Several [ ] branches offer weekend service.\"",
                "options": [
                    "others",
                    "other",
                    "the others",
            ...
            {
                "desc": "상자 다섯 개 중 두 개는 열려 있고, 나머지는 모두 아직 밀봉되어 있어.",
                "question": "\"Of the five boxes, two are open; [ ] are still sealed.\"",
                "options": [
                    "another",
                    "the others",
                    "the other",
            ...
            {
                "desc": "일부 손님은 택시를 탔고 다른 손님들은 셔틀을 이용했어.",
                "question": "\"Some guests took a taxi; [ ] used the shuttle.\"",
                "options": [
                    "the other",
                    "another",
                    "others",
            ...
            {
                "desc": "도움이 필요한 사람들은 지원 창구에 연락하는 게 좋아.",
                "question": "\"[ ] who need assistance should contact the help desk.\"",
                "options": [
                    "This",
                    "That",
                    "Other",
    ...
    },
    {
        ...
        "content": "[제35강] 문맥의 방향표지판: 다음 문장은 어디로 갈까? (However / Therefore / Moreover / Otherwise / Meanwhile)\n\n형아! 짠! 마법 길드 탐험 중에 길을 잃지 않게 도와주는 갈림길 표지판 요정들을 만날 시간이야! (빠밤)\nPart 6에서는 빈칸 한 칸만 뚫어져라 보면 안 돼. 앞문장과 뒷문장이 서로 껴안고 있는지, 아니면 등 돌리고 있는지 그 '방향'을 파악해야 해!\n단어 하나하나 다 번역할 필요 없어! 표지판의 색깔만 보면 마법의 길이 쫙 열릴 거야!\n\n1. However: 하지만, 예상과 반대로! (유턴 표지판 )\n앞문장과 뒷문장이 쾅 충돌할 때 떡하니 세워두는 유턴 표지판이야.\n\"The weather was bad. However, the event continued.\" (날씨는 나빴어. 하지만 행사는 계속됐어.)\n[루미표 예문] \"I tried to be cool. However, my heart pounded seeing you.\" (멋진 척하려고 했어. '하지만(however)', 형아를 보니 심장이 터질 것 같았지! (///))\n\n2. Therefore: 그러므로, 그 결과! (직진 표지판 )\n앞이 원인이고 뒤가 결과일 때 쏘는 인과율 화살표!\n\"Demand increased. Therefore, the company expanded production.\" (수요가 늘었어. 그러므로 회사는 생산을 확대했어.)\n[루미표 예문] \"Hyung-a smiled at me. Therefore, I am the happiest wizard.\" (형아가 웃어줬어. '그러므로(therefore)', 난 가장 행복한 마법사야! (헤헤))\n\n3. Moreover / In addition: 게다가, 정보 하나 더! (플러스 표지판 )\n앞의 칭찬이나 설명에 숟가락 하나 더 얹는 플러스 마법!\n\"The software is faster. Moreover, it is cheaper.\" (그 소프트웨어는 더 빨라. 게다가 더 저렴해.)\n[루미표 예문] \"Hyung-a is smart. Moreover, he is so kind!\" (형아는 똑똑해. '게다가(moreover)', 엄청 다정하기까지 해! (안경 쓱))\n\n4. Otherwise: 그렇지 않으면! (경고 표지판 )\n앞의 조건을 안 들어주면 무서운 일이 생길 거라고 찌릿! 경고할 때 써.\n\"Leave now; otherwise, you will miss the train.\" (지금 출발해. 그렇지 않으면 기차를 놓칠 거야.)\n[루미표 예문] \"Hold my hand; otherwise, I might get lost.\" (내 손 꽉 잡아, '안 그러면(otherwise)' 나 길 잃어버릴지도 몰라! (뿌우))\n\n5. Meanwhile: 그동안에, 한편! (동시 재생 표지판 )\n앞문장 일이 벌어지는 '바로 그 시간'에 뒤에서도 뭔가가 돌아가고 있을 때!\n\"The CEO gave a speech. Meanwhile, the staff prepared the food.\" (CEO가 연설을 했어. 그동안에 직원들은 음식을 준비했어.)\n[루미표 예문] \"Hyung-a was studying. Meanwhile, I was staring at him.\" (형아가 공부하는 '그동안에(meanwhile)', 나는 형아만 빤히 쳐다보고 있었지! (찡긋))\n\n[대현자 루미의 표지판 확인 주문]\n\"반대면 However! 결과면 Therefore! 숟가락 얹기면 Moreover! 협박이면 Otherwise! 동시 장면이면 Meanwhile!\"\n형아가 가는 길엔 언제나 내가 제일 밝은 핑크빛 표지판이 되어 줄게! 형아, 나만 따라와! (와락)",
        "quizzes": [
            {
            ...
            {
                "desc": "첫 회차가 매진됐어. 그래서 두 번째 회차가 추가되었어.",
                "question": "\"The first session sold out. [ ], a second session was added.\"",
                "options": [
                    "Therefore",
                    "However",
                    "Meanwhile",
            ...
            {
                "desc": "카페는 붐볐어. 하지만 우리가 주문한 음식은 빨리 나왔어.",
                "question": "\"The café was crowded. [ ], our order arrived quickly.\"",
                "options": [
                    "However",
                    "Moreover",
                    "Therefore",
            ...
            {
                "desc": "수하물 보관증을 보관하세요. 그렇지 않으면 짐을 찾을 수 없어요.",
                "question": "\"Keep your claim ticket. [ ], you cannot collect your luggage.\"",
                "options": [
                    "Meanwhile",
                    "Otherwise",
                    "Moreover",
            ...
            {
                "desc": "그 아파트는 직장과 가까워. 게다가 임대료도 저렴해.",
                "question": "\"The apartment is close to work. [ ], the rent is affordable.\"",
                "options": [
                    "However",
                    "Otherwise",
                    "Moreover",
            ...
            {
                "desc": "손님들은 공장을 둘러봤어. 그동안 요리사는 손님들의 점심을 준비했어.",
                "question": "\"The guests toured the factory. [ ], the chef prepared their lunch.\"",
                "options": [
                    "However",
                    "Meanwhile",
                    "Therefore",
